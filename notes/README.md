...
- [Malcolm makes scenario reset semantics explicit](modules/malcolm-isolation.md)
- [Malcolm carries fixture identity without owning fixture bytes](modules/malcolm-fixtures.md)
- [Malcolm's parser accepts escaped strings and multiline nested literals](modules/malcolm-parser-robustness.md)
- [Malcolm mutation declarations stay separate from the behavioral contract](modules/malcolm-mutation-declarations.md)
- [Malcolm's first provenance declaration checks Amber execution identity](modules/malcolm-provenance-declarations.md)
...
- [Sentinel's Herdr 0.9.0 compatibility boundary](modules/sentinel-herdr-v0-9-compatibility.md)
...
- [Sentinel's local receipt is sufficient for alpha, not host durability](modules/sentinel-receipt-durability-boundary.md)
...
- [Hammond's deferred GitHub team membership boundary](decision-adjacent/hammond-provider-integration-boundary.md)
- [Solo Hammond authority stays local and unsigned for now](decision-adjacent/hammond-solo-trust-boundary.md)
- [GitHub team membership is an optional future provider adapter](modules/hammond-github-membership.md)
...
- [Store mutations must use the record's referenced policy](modules/hammond-policy-aware-store-mutations.md)
- [A solo Hammond workflow can stay local until trust crosses a boundary](modules/hammond-solo-operations.md)
- [A local preflight should validate dependencies before registration](modules/hammond-local-preflight.md)
...
- [A tagged Sorna build can be verified before CI distribution](modules/sorna-release-publication-policy.md)
- [Release provenance binds exact evidence bytes to build context](modules/sorna-release-provenance.md)
...
- [Malcolm substitutes earlier setup captures in later request bodies](modules/malcolm-capture-interpolation.md)
- [Malcolm uses dotted object paths for nested response selectors](modules/malcolm-response-selectors.md)
