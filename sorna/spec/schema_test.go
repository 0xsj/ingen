...
func TestPublishedSchemaContracts(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			file:                    "ingen.fixture-provider-v1.schema.json",
			constValue:              "ingen.fixture-provider/v1",
			requiredFields:          []string{"fixture_provider"},
			definitions:             []string{"fixture_provider", "fixture"},
			discriminatorDefinition: "fixture_provider",
		},
		{
			name:           "fixture-handoff",
			file:           "ingen.fixture-handoff-v1.schema.json",
			constValue:     "ingen.fixture-handoff/v1",
			requiredFields: []string{"schema", "status", "contract", "provider", "fixtures"},
			definitions:    []string{"contract_reference", "provider_reference", "fixture"},
		},
		{
			name:                    "policy",
		...
		{
			name:           "mutation-plan",
			file:           "ingen.mutation-plan-v1.schema.json",
			constValue:     "ingen.mutation-plan/v1",
			requiredFields: []string{"schema", "status", "catalogue", "contract", "oracle", "baseline", "oracle_policy_sha256", "mutations"},
			definitions:    []string{"catalogue_reference", "contract_reference", "oracle_reference", "baseline_reference", "mutation_entry", "mutation_spec"},
		},
		{
			name:                    "mutation-catalogue",
			file:                    "ingen.mutation-catalogue-v1.schema.json",
			constValue:              "ingen.mutation-catalogue/v1",
			requiredFields:          []string{"mutation_catalogue"},
			definitions:             []string{"catalogue", "mutation"},
			discriminatorDefinition: "catalogue",
		},
		{
			name:           "mutation-preparation",
			file:           "ingen.mutation-preparation-v1.schema.json",
			constValue:     "ingen.mutation-preparation/v1",
			requiredFields: []string{"schema", "provider_id", "plan_path", "plan_sha256", "variants"},
			definitions:    []string{"preparation", "variant", "provenance", "target_resolution"},
		},
		{
			name:           "mutation-provider-review",
			file:           "ingen.mutation-provider-review-v1.schema.json",
			constValue:     "ingen.mutation-provider-review/v1",
			requiredFields: []string{"schema", "status", "plan", "provider", "capabilities", "mutations"},
			definitions:    []string{"plan", "provider", "capability", "mutation"},
		},
		{
			name:           "release",
			file:           "sorna.release-v1.schema.json",
			constValue:     "sorna.release/v1",
			requiredFields: []string{"schema", "name", "version", "commit", "build_date", "artifacts"},
			definitions:    []string{"artifact"},
		},
		{
			name:           "release-verification",
			file:           "sorna.release-verification-v1.schema.json",
			constValue:     "sorna.release-verification/v1",
			requiredFields: []string{"schema", "status", "manifest", "directory", "version", "artifacts"},
			definitions:    []string{"artifact_result"},
		},
		{
			name:           "release-provenance",
			file:           "sorna.release-provenance-v1.schema.json",
			constValue:     "sorna.release-provenance/v1",
			requiredFields: []string{"schema", "name", "version", "source", "build", "manifest", "verification"},
			definitions:    []string{"source", "build", "file", "verification"},
		},
		{
			name:           "report",
