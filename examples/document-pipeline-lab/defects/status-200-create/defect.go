// Package status200create is a controlled defect variant of the document
// pipeline subject.
...
// NewHandler wraps a subject and changes only the successful create status
// from 202 Accepted to 200 OK. All other behavior is delegated unchanged.
